                    ...
                    if shape_info["type"] == "Picture":
                        ...
                        if hasattr(shape, 'PictureFormat'):
                            if hasattr(shape.PictureFormat, 'ColorType'):
                                shape_info["color_type"] = _get_color_type(shape.PictureFormat.ColorType)
...
def insert_inline_picture(backend: WordBackend, com_range_obj: win32com.client.CDispatch, image_path: str, position: str = "after") -> win32com.client.CDispatch:
    """
    ...
    try:
        ...
        if position == "replace":
            ...
            insert_range.Text = ""
            # Insert the picture
            return backend.document.InlineShapes.AddPicture(FileName=image_path, LinkToFile=False, SaveWithDocument=True, Range=insert_range)
...
def add_picture_caption(backend: WordBackend, filename: str, caption_text: str, picture_index: Optional[int] = None, paragraph_index: Optional[int] = None) -> None:
    """
