...
def compare_documents(
    ...
    try:
        ...
        log_error(f"Failed to compare documents: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to compare documents: {str(e)}")
...
def convert_document_format(
    ...
    try:
        ...
        log_error(f"Failed to convert document to {format_type}: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to convert document to {format_type}: {str(e)}")
...
def export_to_pdf(
    ...
    try:
        ...
        log_error(f"Failed to export document to PDF: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to export document to PDF: {str(e)}")
...
def print_document(
    ...
    try:
        ...
        log_error(f"Failed to print document: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to print document: {str(e)}")
...
def protect_document(
    ...
    try:
        ...
        log_error(f"Failed to protect document: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to protect document: {str(e)}")
...
def get_document_statistics(document: win32com.client.CDispatch) -> Dict[str, Any]:
    ...
    try:
        ...
        log_error(f"Failed to get document statistics: {str(e)}", exc_info=True)
        raise WordDocumentError(
            ErrorCode.SERVER_ERROR, f"Failed to get document statistics: {str(e)}")
...
def unprotect_document(document: win32com.client.CDispatch, password: Optional[str] = None) -> bool:
    ...
    try:
        ...
        log_error(f"Failed to unprotect document: {str(e)}", exc_info=True)
        raise WordDocumentError(ErrorCode.SERVER_ERROR, f"Failed to unprotect document: {str(e)}")