...
def set_bold_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, is_bold: bool
):
    """
...
def set_italic_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, is_italic: bool
):
    """
...
def set_font_size_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, size: int
):
    """
...
def set_font_color_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, color: str
):
    """
...
def set_font_name_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, name: str
):
    """
...
def create_bulleted_list_relative_to(
    ...
    new_text_range = backend.document.Range(
        insertion_point, insertion_point + len(full_text)
    )
...
def set_alignment_for_range(
    backend: WordBackend, com_range_obj: win32com.client.CDispatch, alignment: str
):
    """
    ...
    if alignment.lower() in alignment_map:
        ...
        raise ValueError(
            f"Invalid alignment value: {alignment}. Must be 'left', 'center', or 'right'."
        )
...
def add_heading(
    ...
    """
    Add a heading paragraph at the specified range.

    Args:
        backend: The WordBackend instance.
        com_range_obj: COM Range object where to insert the heading.
        text: The heading text.
        level: The heading level (1-9).

    Returns:
        The newly created heading paragraph COM object.
    """
    ...
    try:
        new_para.Style = heading_style
    except Exception as e:
        raise WordDocumentError(f"Failed to apply heading style '{heading_style}': {e}")
