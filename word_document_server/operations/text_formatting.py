...
def get_runs_in_range(
    ...
    Returns:
        COM object containing the runs.
    """
...
def set_paragraph_style(
    element: win32com.client.CDispatch, 
    style_name: str
) -> None:
    """
...
@handle_com_error(ErrorCode.FORMATTING_ERROR, "add heading")
def add_heading(
...
# === Font Formatting Operations ===

@handle_com_error(ErrorCode.FORMATTING_ERROR, "set bold formatting")
def set_bold_for_range(
    ...
    Returns:
        None
    """
    com_range_obj.Font.Bold = 1 if is_bold else 0  # wdToggle or wdFalse


@handle_com_error(ErrorCode.FORMATTING_ERROR, "set italic formatting")
def set_italic_for_range(
    ...
    Returns:
        None
    """
    com_range_obj.Font.Italic = 1 if is_italic else 0  # wdToggle or wdFalse


@handle_com_error(ErrorCode.FORMATTING_ERROR, "set underline formatting")
...
def set_font_size_for_range(
    ...
    Args:
        com_range_obj: COM Range object to format.
        size: The font size in points (e.g., 12 for 12-point font).
...
def set_font_name_for_range(
    ...
    Args:
        com_range_obj: COM Range object to format.
        font_name: The font name to apply (e.g., "Arial", "Times New Roman").
...
def set_font_color_for_range(
    ...
    Raises:
        WordDocumentError: If an invalid color format is provided.
    """
    color_map = {
        "black": 0,
        "white": 16777215,
...
def set_alignment_for_range( 
    ...
    Raises:
        WordDocumentError: If an invalid alignment value is provided.
    """
    alignment_map = {
...
@handle_com_error(ErrorCode.FORMATTING_ERROR, "insert paragraph")
...
@handle_com_error(ErrorCode.FORMATTING_ERROR, "insert bulleted list")
def insert_bulleted_list(
    ...
    Args:
        ...
        items: List of strings to use as bullet items.
        style: The bullet style to use (currently unused but kept for API consistency).

    Returns:
        None
    """
    # Insert each item as a paragraph
    ...
    # Apply bullet formatting to the entire range
