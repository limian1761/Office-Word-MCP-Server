...
class TestSelector(unittest.TestCase):
    ...
    def test_text_filter_selection(self):
        ...
        # 测试选择包含特定文本的段落
        locator = {
            "target": {"type": "paragraph", "filters": [{"contains_text": "关键词"}]}
        }
    ...
    def test_anchored_selection(self):
        ...
        locator = {
            "anchor": {
                "type": "paragraph",
                "identifier": {"text": "这是第二段文本，包含关键词。"},
            },
            "relation": {"type": "immediately_following"},
            "target": {"type": "table"},
        }
    ...
    def test_invalid_locator(self):
        """测试无效定位器"""
        # 测试缺少target的定位器
        invalid_locator = {"anchor": {"type": "paragraph"}}
