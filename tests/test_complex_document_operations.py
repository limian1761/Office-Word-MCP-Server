...
from word_docx_tools.mcp_service.core_utils import format_error_response
...
class TestComplexDocumentOperations(unittest.TestCase):
    ...
    def test_document_open_and_outline(self):
        ...
        # 2. 获取文档大纲
        result = document_tools(ctx=self.context, operation_type="get_info")
    ...
    def test_text_search_and_formatting(self):
        ...
        result = text_content_operation(
            ctx=self.context, operation_type="find", text="第二个段落"
        )
